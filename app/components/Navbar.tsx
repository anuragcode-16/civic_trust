      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
            ...
            <div className="flex space-x-4">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  href={item.href}
                  className={`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium ${isActive(item.href)
          ...
          <div className="hidden sm:flex sm:items-center">
            ...
            <Link
              href="/builder"
              className={`mr-4 px-4 py-2 rounded-md flex items-center text-sm font-medium transition-colors ${isBuilderPath()
      ...
      {isMenuOpen && (
        <div className={`sm:hidden ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`} id="mobile-menu">
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link
              href="/builder"
              className={`block pl-3 pr-4 py-3 text-base font-medium ${isBuilderPath()
                  ? 'bg-primary text-white'
                  : 'bg-primary text-white'
            ...
            <button
              ...
              className={`w-full text-left flex items-center pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium ${isDarkMode ? 'text-gray-300 hover:bg-gray-700 hover:text-white' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700'
                }`}
            >
